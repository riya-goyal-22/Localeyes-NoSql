...
type UserRepository interface {
	...
	FetchUserById(ctx context.Context, uid string, isUserActive bool) (*models.User, error)
	...
	GetAllUsers(ctx context.Context, params models.GetUsersParams) ([]*models.User, error)
